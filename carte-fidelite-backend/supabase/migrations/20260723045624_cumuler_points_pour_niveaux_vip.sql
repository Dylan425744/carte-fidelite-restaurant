-- Ajoute l'incrementation de points_cumules (jamais remis a zero) dans la
-- fonction securisee existante qui traite deja chaque scan. Copie exacte
-- de la definition actuelle, avec une seule ligne ajoutee : le reste du
-- controle anti-fraude et de l'enregistrement du scan reste identique.
